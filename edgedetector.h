...
private:
	...
	cv::Mat sobel;  // 16-bit signed int image
	int aperture;  // Aperture size of the Sobel kernel
	cv::Mat sobelMagnitude;  // Sobel magnitude
	cv::Mat sobelOrientation;  // Sobel orientation
